  ...
  <svg class="hidden" xmlns="http://www.w3.org/2000/svg">
    ...
    <symbol class=" flex justify-center" id="icon_chat" viewBox="0 0 16 16">
      <g>
        ...
        <path class="st0"
          d="M8,12.1H4.7c-0.4,0-0.8-0.3-0.8-0.8s0.3-0.8,0.8-0.8H8c0.4,0,0.8,0.3,0.8,0.8S8.4,12.1,8,12.1z" />
      </g>
    </symbol>
  </svg>
