...
},{"./vue-zoomer.vue":"D9HK","./vue-zoomer-gallery.vue":"zZjH"}],"hWNS":[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t={data:function(){return{zoomed:!1,imageAspectRatio:1}},methods:{onImageLoad:function(t){var e=t.target;this.imageAspectRatio=e.naturalWidth/e.naturalHeight}}};exports.default=t;
(function(){var o=exports.default||module.exports;"function"==typeof o&&(o=o.options),Object.assign(o,{render:function(){var o=this,t=o.$createElement,e=o._self._c||t;return e("div",{staticStyle:{padding:"100px"}},[e("div",[o._v(" zoomed: "+o._s(o.zoomed)+" "),e("button",{on:{click:function(t){return o.$refs.zoomer.zoomIn()}}},[o._v("+")]),o._v(" "),e("button",{on:{click:function(t){return o.$refs.zoomer.zoomOut()}}},[o._v("-")])]),o._v(" "),e("v-zoomer",{ref:"zoomer",staticStyle:{width:"800px",height:"500px",border:"1px solid silver"},attrs:{"aspect-ratio":o.imageAspectRatio,"max-scale":10,"zooming-elastic":!1,zoomed:o.zoomed},on:{"update:zoomed":function(t){o.zoomed=t}}},[e("img",{staticStyle:{"object-fit":"contain",width:"100%",height:"100%"},attrs:{src:"landscape-1.7df5f544.jpg"},on:{load:o.onImageLoad}})])],1)},staticRenderFns:[],_compiled:!0,_scopeId:null,functional:void 0});})();
},{"./../assets/landscape-1.jpg":[["landscape-1.7df5f544.jpg","odg5"],"odg5"]}],"epB2":[function(require,module,exports) {
...
//# sourceMappingURL=main.3f7daea5.js.map